...
export function AudioDeviceSettings({
  ...
  const setVoiceDevices = useVoiceStore((s) => s.setAudioDevices);
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              void setVoiceDevices({ audioInputId: value, audioOutputId: audioOutputDeviceId ?? null });
            }}
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              void setVoiceDevices({ audioInputId: audioInputDeviceId ?? null, audioOutputId: value });
            }}
            className={selectClassName}
